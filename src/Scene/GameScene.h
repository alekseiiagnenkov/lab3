...
void doPlayerEvents(bool* flag, bool* flagClick, bool* flagZoneClick, std::vector<Object *> &objects, float x, float y, int width, int height, Level* level, Window* window, Lair *&lair, sf::Font&);
